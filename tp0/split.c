...
/*
 * Recibe un puntero donde insertar el resultado, un string valido (finalizado en '\0') del cual se va a sustraer la parte deseada, 
 * y dos insigned ints de inicio y final (no incluido) de caracteres a sustraer
 * 
 * La funcion guarda en el destino un string valido sustraido de otro, arrancando en inicio hasta final no incluido
...
/*
 * Recibe un vector con strings de elementos creado por el split y libera cada uno de esos strings del heap y luego libera el vector
 * 
 */
